                        ...
                        {comments &&
                            comments.map((item, idx) => (
                                <tr key={idx} className="odd:bg-gray-50 even:bg-white">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">{item.senderId}</td>
                                    <td className="px-6 py-4 whitespace-nowrap">{item.text}</td>
                                    <td className="px-6 py-4 whitespace-nowrap"><input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="type here..."/></td>
