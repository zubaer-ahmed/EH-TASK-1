            ...
            <div className='mx-auto w-64 flex-shrink-0 text-center md:mx-0 md:text-left'>
              <a className='title-font flex items-center justify-center font-medium text-white md:justify-start'>
                {
                  ...
                  <div className='flex items-center'>
                    ...
                    <svg fill="#4B0082" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M4 21h17v-2H5V3H3v17a1 1 0 0 0 1 1z"></path><circle cx="10" cy="8" r="2"></circle><circle cx="18" cy="12" r="2"></circle><circle cx="11.5" cy="13.5" r="1.5"></circle><circle cx="16.5" cy="6.5" r="1.5"></circle></svg>
              ...
              <div className='mt-4'>
                <span className='mt-2 inline-flex justify-center sm:ml-auto sm:mt-0 sm:justify-start'>
                  ...
                  <svg fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M13.397 20.997v-8.196h2.765l.411-3.209h-3.176V7.548c0-.926.258-1.56 1.587-1.56h1.684V3.127A22.336 22.336 0 0 0 14.201 3c-2.444 0-4.122 1.492-4.122 4.231v2.355H7.332v3.209h2.753v8.202h3.312z"></path></svg>
                  </a>
          ...
          <div className='bg-black'>
            <div className='container mx-auto px-5 py-4'>
              <p className='text-center text-sm capitalize text-white'>
                ...
                <span className='text-indigo-500'>Engineer Hut</span>
              </p>
            </div>
          </div>
        </footer>
