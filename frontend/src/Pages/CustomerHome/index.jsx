...
export default function Page() {
  ...
  return (
    <div className="flex relative flex-col">
      <div className="w-full h-12 bg-gray-100 flex items-center px-4 border shadow space-x-2" onClick={() => setShowSideBar(true)}>
        <Icon>menu</Icon>
        <div>More</div>
      </div>
      <div className={`${!showSideBar ? "-translate-x-full" : ""} overscroll-none top-0 left-0 no-scrollbar w-full z-10 bg-white absolute sm:sticky basis-full sm:basis-3/12 flex flex-col p-6 pb-24 rounded-lg border-r  sm:top-[4.5em] h-screen overflow-auto`}>
