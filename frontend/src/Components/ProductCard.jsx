...
const ProductCard = ({ object: { rating, cost, price, budget, title, description, category, worker, employer }, object }) => {
    console.log(object);
            ...
            <div className="w-full md:w-2/3 bg-white flex flex-col space-y-2 p-3">
                <div className="flex justify-between item-center">
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="flex space-x-1 text-gray-600 font-bold text-sm ml-1">
                            <div>{rating || 4.5}</div >
                ...
                <p className="md:text-lg text-gray-500 text-base">{description && false || `Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime mollitia,
