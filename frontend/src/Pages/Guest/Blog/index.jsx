        ...
        <>
            <section className="bg-white">
                <div className="container px-6 py-10 mx-auto">
                    <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl">Recent Blogs</h1>
                    ...
                    <div className="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2">
                        <div className="lg:flex">
                            ...
                            <div className="flex flex-col justify-between py-6 lg:mx-6">
                                <a href="/blogs/details" className="text-xl font-semibold text-gray-800 hover:underline ">
...
<<<<<<< HEAD
                ...
                <div class="lg:flex">
                    ...
                    <div class="flex flex-col justify-between py-6 lg:mx-6">
                        <a href="/blogs/details" class="text-xl font-semibold text-gray-800 hover:underline  ">
                            How to use sticky note for problem solving
                        </a>
...
>>>>>>> 8682b071c4565b9ee78621b2ea94cfbb8bc4b533
}
